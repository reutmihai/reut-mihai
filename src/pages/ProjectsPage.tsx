...
const ProjectsPage: React.FC = () => {
  return (
    <main className="flex flex-col max-w-6xl mx-auto px-6 py-16">
      ...
      <div className="my-8 flex flex-col gap-3 border border-gray-300 p-15">
        <h2>BPS PAVING APP - INDIVIDUAL PROJECT</h2>
        ...
        <p className="text-lg leading-relaxed">
          ...
          paving company. <br /> &gt; The project included a responsive design, service
          presentation, portfolio galleries, client reviews, and a contact form. <br />
